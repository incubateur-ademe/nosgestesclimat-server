...
const saveSimulationViaEmailRoute = require('./routes/saveSimulationTestEnd/saveSimulation')
...
const addMemberRoute = require('./routes/groups/addMember')
const deleteGroupRoute = require('./routes/groups/deleteGroup')
const fetchGroupRoute = require('./routes/groups/fetchGroup')
const fetchGroupAsMemberRoute = require('./routes/groups/fetchGroupAsMember')
const updateGroupRoute = require('./routes/groups/updateGroup')
const updateMemberRoute = require('./routes/groups/updateMember')
